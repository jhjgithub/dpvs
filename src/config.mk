...
CFLAGS += -D CONFIG_DPVS_ENABLE_LOCAL_DEBUG
CFLAGS += -D CONFIG_NS_DEBUG
# using Rx interrupt
CFLAGS += -D CONFIG_ENABLE_RX_INTERRUPT
CFLAGS += -D __LITTLE_ENDIAN

#CFLAGS += -D CONFIG_DPVS_NEIGH_DEBUG
#CFLAGS += -D CONFIG_DPVS_IPV4_DEBUG
